...
const cdData = [
    {title: "Colin Stetson - When we were that wept for the sea",
     ...
     coverMiddle: "/cd-covers/blueCD-mid.png",
...
const vinylData = [
    ...
    coverMedium: "/vinyl-covers/XTC-mid.png",
    description: "ababa cnsdkc yes!",
    price: "300.00"},
    ...
    genre: "synthpop",
     ...
     coverMedium: "/vinyl-covers/Klark-Kent-mid.png",
     description: "ababa cnsdkc yes!",
     price: "300.00"},
     ...
     coverMedium: "/vinyl-covers/jah-wurzel-mid.png",
     description: "ababa cnsdkc yes!",
     price: "300.00"},
